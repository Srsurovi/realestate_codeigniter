    ...
    <div class="searchbar">
      <div class="row">
        <div class="col-lg-6 col-sm-6">
          ...
          <div class="row">
            ...
            <select class="form-control">
              ...
              <div class="col-lg-3 col-sm-4">
              <button class="btn btn-success"  onclick="window.location.href='<?php echo base_url() ; ?>pages/buysalerent'">Find Now</button>
              </div>
          </div>
        ...
        <div class="col-lg-5 col-lg-offset-1 col-sm-6 ">
         ...
         <a class="color4" href="<?php echo base_url('login'); ?>"> <button class="btn btn-info" >Login</button> </a>       </div>
      </div>
    </div>
  </div>
</div>
...
<div class="container">
 <div class="row">
      <div class="col-lg-12 col-sm-6 recent-view">
					<h2>NEW PRODUCTS</h2>
  ...
  <div class="properties-listing spacer"> <a href="<?php echo base_url() ; ?>pages/buysalerent" class="pull-right viewall">View All Listing</a>
    ...
    <div id="owl-example" class="owl-carousel">
      <div class="properties">
        ...
        <h4><a href="<?php echo base_url() ; ?>pages/property">Royal Inn</a></h4>
        <p class="price">Price: $234,900</p>
        <div class="listing-detail"><span data-toggle="tooltip" data-placement="bottom" data-original-title="Bed Room">5</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Living Room">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Parking">2</span> <span data-toggle="tooltip" data-placement="bottom" data-original-title="Kitchen">1</span> </div>
        <a class="btn btn-primary" href="<?php echo base_url() ; ?>pages/property">View Details</a>
      </div>
      <div class="properties">
  ...
  <div class="spacer">
    <div class="row">
      <div class="col-lg-6 col-sm-9 recent-view">
        <h3>About Us</h3>
        <p>The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from "de Finibus Bonorum et Malorum" by Cicero are also reproduced in their exact original form, accompanied by English versions from the 1914 translation by H. Rackham.<br><a href="<?php echo base_url() ; ?>home/about.php">Learn More</a></p>
        ...
        <div id="myCarousel" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item active">
              <div class="row">
                <div class="col-lg-4"><img src="<?php echo base_url() ; ?>assets/images/properties/1.jpg" class="img-responsive" 
				alt="properties"/></div>
                <div class="col-lg-8">
                  <h5><a href="<?php echo base_url() ; ?>pages/property">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
                  <a href="<?php echo base_url() ; ?>pages/property" class="more">More Detail</a> </div>
              </div>
            </div>
            <div class="item">
              <div class="row">
                <div class="col-lg-4"><img src="<?php echo base_url() ; ?>assets/images/properties/2.jpg" class="img-responsive" 
				alt="properties"/></div>
                <div class="col-lg-8">
                  <h5><a href="<?php echo base_url() ; ?>pages/property">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
            ...
            <div class="item">
              <div class="row">
                <div class="col-lg-4"><img src="<?php echo base_url() ; ?>assets/images/properties/3.jpg" class="img-responsive" 
				alt="properties"/></div>
                <div class="col-lg-8">
                  <h5><a href="<?php echo base_url() ; ?>pages/property">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
            ...
            <div class="item">
              <div class="row">
                <div class="col-lg-4"><img src="<?php echo base_url() ; ?>assets/images/properties/4.jpg" class="img-responsive" 
				alt="properties"/></div>
                <div class="col-lg-8">
                  <h5><a href="<?php echo base_url() ; ?>pages/property">Integer sed porta quam</a></h5>
                  <p class="price">$300,000</p>
