...
<div class="row">
            <div class="col-lg-3 col-sm-3">
                   <h4>Information</h4>
                   <ul class="row">
						 <li><a href="<?php echo base_url() ; ?>home/about.php">About</a></li>
						<li><a href="<?php echo base_url() ; ?>home/agents.php">Agents</a></li>         
						<li><a href="<?php echo base_url() ; ?>home/blog.php">Blog</a></li>
