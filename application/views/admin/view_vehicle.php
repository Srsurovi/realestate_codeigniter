...
<div class="right_col" role="main">
    <div class="">
        ...
        <hr>
        <a class="btn btn-primary" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample"> Add A new Houses</a>
			...
			<?php echo form_open_multipart('admin/vehicles/add'); ?>
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <label>House Category</label>
                            <select class="form-control" name="category" >
                                <option value="Subcompact">Booking</option>
                                <option value="Compact">Rent</option>
                                <option value="Mid-size">Selling</option>
                                <option value="Full-size">Sub-renting</option>
                                <option value="Mini-Van">Mini</option>
                            </select>
                        </div>
                        <div class="col-xs-6">
                            <br>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <br>
                            <label for="gear">Paymeny Type:</label>
                            <select name="gear" id="gear" class="form-control">
                                <option value="auto">Cash</option>
                                <option value="manual">Installment</option>
                            </select>
                        </div>
                        <div class="col-xs-6">
                        <br>
                            <label for="mileage">Square-Feet:</label>
                            <input type="text" step="any" class="form-control" name="mileage" placeholder="Square-Feet" required>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-6">
                            <br>
                            <input class="form-control" name="e_no" placeholder="House Number" required>
                        </div>
                        <div class="col-xs-6">
                            <br>
                            <input class="form-control" name="c_no" placeholder="Road/Block Number" required>
                        </div>
                    </div>
