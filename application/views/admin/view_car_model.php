...
<div class="right_col" role="main">
    <div class="">
        ...
        <!-- add new model -->
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target=".add-model">Add New House</button>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="gridSystemModalLabel">Add new House</h4>
                    </div>
                <div class="modal-body">
                    <?php echo form_open_multipart('admin/car_model/addModel'); ?>
                            <fieldset>
                                ...
                                <div class="form-group">
                                   <label for="manufacturer_id"> Company Name:</label>
                                ...
                                <div class="form-group">
                                    <label for="model_description">House Description:</label>
