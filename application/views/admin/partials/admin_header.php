        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
             <a href="<?php echo base_url() ; ?>" class="site_title"><i class="fa fa-paw"></i> <span>REAL-ESTATE</span></a>
            </div>
              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Manage Employee <span class="fa fa-chevron-down"></span></a>
                    ...
                    <li>
                        <a><i class="fa fa-desktop"></i>Rent &amp; Selling <span class="fa fa-chevron-down"></span></a>

                        <ul class="nav child_menu">
                          <li><a href="<?php echo base_url() . 'admin/manufacturers';?>">Add Rent</a></li>
                          <li><a href="<?php echo base_url() . 'admin/car_model';?>">Add selling</a></li>
                        </ul>
                    </li>
                    <?php endif; ?>
                  <li><a><i class="fa fa-table"></i> House <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('admin/vehicles'); ?>">All House</a></li>
                      <li><a href="<?= base_url('admin/vehicles/soldlist'); ?>">Sold House</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
